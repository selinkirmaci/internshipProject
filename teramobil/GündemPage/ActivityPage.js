        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.populationView}>
                <View style = {{flex: 2,flexDirection: 'row',alignItems:'center'}}>
                    ...
                    <Text style={{...styles.populationTitle,fontSize:30,fontWeight:'bold',marginLeft:15,marginRight:150}}>Etkinlikler</Text>
                    <FontAwesome5 name='calendar' size={25}  onPress={()=>{props.navigation.navigate('ActivityCalendar');}}></FontAwesome5>
